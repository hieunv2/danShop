...
include 'global/function-cart.php';
 ?>
<header class="header">
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/phone.png" alt=""></div>+841234260199</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/mail.png" alt=""></div><a href="mailto:onetechshop@gmail.com">onetechshop@gmail.com</a></div>
					...
					<?php if(isset($_SESSION['login'])) : $u = $_SESSION['login']; ?>	
							...
							<ul class="dropdown-menu">
								<li><a href="users.php"><i class="fas fa-user" style="margin: 10px;"></i>My Account</a></li>
								<li><a href="orderhistory.php"><i class="fas fa-history" style="margin: 10px;"></i>History Orders</a></li>
								<li><a href="logout.php"><i class="fas fa-sign-out-alt" style="margin: 10px;"></i>Log out</a></li>
							</ul>
						</li>
						...
						<div class="header_search">
							<div class="header_search_content">
								<div class="header_search_form_container">
									<form action="search.php" class="header_search_form clearfix" method="GET">
							...
							<div class="cart">
								<div class="cart_container d-flex flex-row align-items-center justify-content-end">
									<div class="cart_icon">
										...
										<div class="cart_count"><span><?php echo tong_so_luong(); ?></span></div>
									</div>
									<div class="cart_content">
										<div class="cart_text"><a href="cart.php">Cart</a></div>
										<div class="cart_price">$<?php echo tong_tien(); ?></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									...
									<li><a href="category-product.php?id=<?= $c['id'] ?>"><?php echo $c['name']; ?> <i class="fas fa-chevron-right ml-auto"></i></a></li>
								<?php endforeach; ?>
								</ul>
							</div>
							...
							<div class="main_nav_menu ml-auto">
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<li >
										<a href="shop.php">Shop Product</a>
									</li>
									<li><a href="blog.php">Blog<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="contact.php">Contact<i class="fas fa-chevron-down"></i></a></li>
								</ul>
